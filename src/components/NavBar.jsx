    ...
    <div>
      <nav className={`flex items-center justify-between h-16 fixed w-full z-50 ${sticky ? "bg-blue-950" : ""}   `}>
          ...
          <div className='flex gap-10 md:gap-6 sm:gap-3 cursor-pointer text-white'>
            ...
            <RouterLink to='/student/login'>Student Login</RouterLink>
          </div>
        <div className="flex items-center gap-3">
            <RouterLink to='/apply' className='bg-blue-700 hover:bg-blue-600 text-white px-5 py-2 rounded font-bold mr-2'>Apply Now</RouterLink>
